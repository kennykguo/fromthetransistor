...
void Vblinking_led___024root___nba_sequent__TOP__0(Vblinking_led___024root* vlSelf);
...
VL_INLINE_OPT void Vblinking_led___024root___nba_sequent__TOP__0(Vblinking_led___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vdly__blinking_led__DOT__count;
    __Vdly__blinking_led__DOT__count = 0;
    // Body
    __Vdly__blinking_led__DOT__count = vlSelfRef.blinking_led__DOT__count;
    if ((0x1fU == vlSelfRef.blinking_led__DOT__count)) {
        vlSelfRef.led = (1U & (~ (IData)(vlSelfRef.led)));
        __Vdly__blinking_led__DOT__count = 0U;
    } else {
        __Vdly__blinking_led__DOT__count = ((IData)(1U) 
                                            + vlSelfRef.blinking_led__DOT__count);
    }
    vlSelfRef.blinking_led__DOT__count = __Vdly__blinking_led__DOT__count;
}

void Vblinking_led___024root___eval_triggers__act(Vblinking_led___024root* vlSelf);

bool Vblinking_led___024root___eval_phase__act(Vblinking_led___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vblinking_led___024root___eval_phase__act\n"); );
    Vblinking_led__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vblinking_led___024root___eval_phase__nba(Vblinking_led___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vblinking_led___024root___eval_phase__nba\n"); );
    Vblinking_led__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
void Vblinking_led___024root___eval(Vblinking_led___024root* vlSelf) {
    ...
    while (__VnbaContinue) {
        ...
        while (vlSelfRef.__VactContinue) {
            ...
            if (Vblinking_led___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vblinking_led___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
